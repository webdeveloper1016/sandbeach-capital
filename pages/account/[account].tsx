...
const IndividualAccountPage = () => {
  return (
    <PortfolioData>
      {(data) => (
        <div>
          <AccountWatchlistLinks
            active={data.accountName as AirTableAccountRoutes}
          />
          <AccountBalanceHeader
            accountName={data.accountName as AirTableAccountRoutes}
            balance={data.accountRouteData.summary.balance.display}
            percChange={data.accountRouteData.summary.dayChange.perc.display}
            percClass={data.accountRouteData.summary.dayChange.class}
            weight={data.accountRouteData.summary.weight}
          />
          <AccountTable
            columns={[
              {
            ...
            data={data.accountRouteData.quotes}
          />
        </div>
      )}
    </PortfolioData>
